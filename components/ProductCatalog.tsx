  ...
  return (
    <section id="productos" className="pb-10 pt-5 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="sticky top-[60px] md:top-[70px] z-40 bg-background/95 backdrop-blur-sm -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 py-4 border-b border-border/50 shadow-sm transition-all">
